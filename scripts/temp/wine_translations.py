...
def normalize_product_name(
    ...
    *,
    ...
    """
    Remove retailer-added suffixes from a wine name only when
    they duplicate structured attributes already extracted.

    Examples:
        Carl Jung Mousseaux (bezalkoholowe)
        → Carl Jung Mousseaux

        Elibo Alaverdi białe półwytrawne
        → Elibo Alaverdi

        Santo Isidro Semi Sweet Tinto
        → unchanged
    """
