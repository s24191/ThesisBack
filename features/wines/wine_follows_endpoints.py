...
from shared.models.wine import Wine, RetailerWine, Country, Region, Retailer, VivinoWine
...
async def get_my_followed_wines(
    ...
    stmt = (
        select(Wine, Country, Region, VivinoWine, RetailerWine, Retailer)
    ...
    for wine, country, region, vivino, offer, retailer in rows:
